...
<body class="bg-slate-100 min-h-screen flex flex-col items-center justify-center">
    ...
    <div class="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8 border border-slate-100 my-8">
        ...
        <div class="text-center mb-8">
            <h2 class="text-3xl font-bold text-slate-800">สมัครสมาชิกใหม่ (สำหรับ admin)</h2>
            <p class="text-slate-500 mt-2 text-sm">กรอกข้อมูลด้านล่างเพื่อสร้างบัญชีผู้ใช้งาน</p>
        </div>

        <form action="admin_regis_action.php" method="POST" onsubmit="return checkPasswordMatch();" class="space-y-5">
